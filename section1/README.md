...
----------------------------------------------------------------
![Tip](../images/tips.ico)  I can develop code for analysis on my Mac laptop.  I
                          can then install the *same* code on our 20k core cluster and run it in 
                          parallel on 100 samples, monitor the process, and
                          then update a database with R when complete.
